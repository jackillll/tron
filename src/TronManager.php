...
use Jackillll\Tron\Provider\{HttpProvider, HttpProviderInterface};

/**
 * Tron Manager
 *
 * Manages multiple HTTP providers for different TRON network nodes and services.
 * This class handles the coordination between Full Node, Solidity Node, Event Server,
 * Explorer, and Sign Server providers, providing a unified interface for making
 * requests to the appropriate endpoints.
 *
 * Key features:
 * - Multi-provider management (Full Node, Solidity Node, Event Server, etc.)
 * - Automatic provider initialization with default nodes
 * - Request routing based on endpoint patterns
 * - Connection status monitoring
 * - Fallback to default nodes when providers are not specified
 * - Support for custom HTTP providers and configurations
 *
 * @package Jackillll\Tron
 * @author  Jackillll <jackjack75383973@gmail.com>
 * @since   2.0.0
