...
/**
 * Laravel Tron API Package - TRC20 Contract Handler
 *
...
/**
 * TRC20 Contract Handler
 *
 * This class provides functionality for interacting with TRC20 tokens on the Tron blockchain:
 * - Token information retrieval (name, symbol, decimals, total supply)
 * - Balance queries for specific addresses
 * - Token transfer operations
 * - Allowance management (approve, transferFrom)
 * - Event monitoring and transaction history
 *
 * @package Jackillll\Tron
 * @author  Jackillll <jackjack75383973@gmail.com>
 * @author  Shamsudin Serderov <steein.shamsudin@gmail.com> (Original Author)
