...
use Jackillll\Tron\Support\Ethabi;

/**
 * Transaction Builder
 *
 * Provides comprehensive transaction building functionality for the TRON blockchain.
 * This class handles the creation and preparation of various types of transactions
 * including TRX transfers, smart contract interactions, token operations, and
 ...
 * - Asset operations (freeze, unfreeze, vote)
 * - Super representative operations
 * - Energy and bandwidth management
 * - Multi-signature support
 * - ABI encoding/decoding for smart contracts
 *
 * @package Jackillll\Tron
 * @author  Jackillll <jackjack75383973@gmail.com>
 * @since   2.0.0
